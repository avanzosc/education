...
Module that creates different objects that will be used to configure a
education center.

* Academic Year (with start and end dates)
* Activity type

* For center in Basque Country module *hezkuntza* will extend and connect to
  service provided by Autonomic Govern
