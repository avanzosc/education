...
class EducationGroupTeacherTimetableReport(models.Model):
    _name = 'education.group.teacher.timetable.report'
    _inherit = 'education.group.teacher.report'
    _description = 'Teacher Timetable Report'
    _auto = False
    ...
    def _select(self):
        ...
        """
        return (super(EducationGroupTeacherTimetableReport, self)._select() +
                select_str)
    ...
    def _from(self):
        ...
        """
        return (super(EducationGroupTeacherTimetableReport, self)._from() +
                from_str)
